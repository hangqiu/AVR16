...
#include "src/ORB_SLAM2/include/MapDrawer.h"
#include "src/ORB_SLAM2/include/MapPoint.h"
...
namespace ORB_SLAM2 {
    ...
    void MapDrawer::DrawMapPointsOffline(pcl::PointCloud <pcl::PointXYZ>::Ptr cloudPtr) {
        ...
        for (size_t pointCounter = 0, pointCloudEnd = cloudPtr->points.size(); pointCounter < pointCloudEnd; pointCounter++) {
            glVertex3f(cloudPtr->points[pointCounter].x, cloudPtr->points[pointCounter].y, cloudPtr->points[pointCounter].z);
        }
        glEnd();
