...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, bool is_save_map=false, bool reuseMap = false, string pathToMapFile = "", bool runLocalizationMode = true);
